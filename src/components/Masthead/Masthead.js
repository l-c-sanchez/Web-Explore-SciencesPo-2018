        ...
        return (
            <div className="Masthead">
                <div className="Masthead__item">
                    <span className="Masthead__label">Conçu, écrit et réalisé par</span>
                ...
                <div className="Masthead__item">
                    <span className="Masthead__label">Traductions</span>
                ...
                <div className="Masthead__item Masthead__item--full">
                    <span className="Masthead__details"><span className="Masthead__label">Correction :</span> Anaïs Bohuon, l’AJL (Association des Journalistes LGBT), Grégory Blachier, Simon Ruben, Patrice Trapier</span>
                </div>
                <div className="Masthead__item Masthead__item--full">
                    <span className="Masthead__details"><span className="Masthead__label">Photos :</span> Charlotte Durand et archives personnelles d’Erik Schinegger</span>
                </div>
                <div className="Masthead__item Masthead__item--full">
                    <span className="Masthead__details"><span className="Masthead__label">Vidéos :</span> Charlotte Durand, Aurore Gayte, Stanislas Vignon</span>
                </div>
                <div className="Masthead__item Masthead__item--full">
                    <span className="Masthead__details"><span className="Masthead__label">Remerciements :</span> Ecole de Journalisme de Sciences Po, Erik et Christa Schinegger</span>
                </div>
            </div>
        );
    }
