        ...
        return (
            <div id="board" className="Board" style={{marginTop:this.state.boardTop, left:0,  minWidth:this.state.slideWidth, height: this.state.boardHeight}}>
                ...
                <div className="Board__slide white_blue Board__slide--bottom">
                    <Element name="AP-CHAP00-CITATION1.png" positionLeft="0%"></Element>
                ...
                <div className="Board__slide Board__slide--bottom white_blue"> 
                      <Element name="AP-CHAP01-CITATION3.png" index="m1" positionLeft="30%"></Element>
                    <Element name="CHAP01-CITATION3.png" index="p1" positionLeft="30%"></Element>
 ...
 */}
                ...
                <div className="Board__slide Board__slide--middle only_blue">
                    <Element name="CHAP04-CITATION3.png" index="m1" positionLeft="30%" ></Element>
                </div>
                <div className="Board__slide Board__slide--middle js-board-doubleslide only_blue">
